...
RUTA_ACTUAL = {
     ...
     "columnas": {
          ...
          "id_ruta": {"num": 4, "encabezado": "ID RUTA"},
          "id": {"num": 5, "encabezado": "ID CLIENTE"},
          "rut": {"num": 6, "encabezado": "RUT"},
          "cliente": {"num": 7, "encabezado": "CLIENTE"},
          "direccion": {"num": 8, "encabezado": "DIRECCION"},
          "comuna": {"num": 9, "encabezado": "COMUNA"},
          "telefono": {"num": 10, "encabezado": "TELEFONO"},
...
RUTAS_BD = {
     ...
     "columnas": {
          ...
          "id": {"num": 3, "encabezado": "ID CLIENTE"},
          "contrato": {"num": 4, "encabezado": "CONTR."},
          ...
          "status": {"num": 12, "encabezado": "STATUS"},
          "detalleretiro": {"num": 13, "encabezado": "DETALLE"},
          "farmaco": {"num": 14, "encabezado": "FARMACO"},
          "patologico": {"num": 15, "encabezado": "PATOLOGICO"},
          "contaminado": {"num": 16, "encabezado": "CONTAMINADO"},
          "cortopunzante": {"num": 17, "encabezado": "CORTOPUNZANTE"},
          "otropeligroso": {"num": 18, "encabezado": "OTRO PELIGROSO"},
          "liquidorx": {"num": 19, "encabezado": "LIQUIDOS RX"},
          "cajaroja_0.5": {"num": 20, "encabezado": "CAJA ROJA 0.5 lts"},
          "cajaroja_1": {"num": 21, "encabezado": "CAJA ROJA 1 lt"},
          "cajaroja_1.3": {"num": 22, "encabezado": "CAJA ROJA 1.3 lts"},
          "cajaroja_1.65": {"num": 23, "encabezado": "CAJA ROJA 1.65 lts"},
          "cajaroja_3": {"num": 24, "encabezado": "CAJA ROJA 3 lts"},
